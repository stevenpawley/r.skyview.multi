...
#               Steven Pawley <steven.pawley gmail.com> (parallelization)
#
# PURPOSE:      Implementation of Sky-View Factor visualization technique
#
# COPYRIGHT:    (C) 2013-2021 by the GRASS Development Team
#
...
#%flag
#% key: p
#% label: Do not process in parallel
#% description: Do not process horizon rasters in parallel
#%end
